//
//  Rv+Convenience.swift
//  RvBNB
//
//  Created by Austin Potts on 9/27/19.
...
extension User {
    //Model Representation for Core Data to be sent to API
    ...
    //Model Representation Convenience Init
...
//ModelRepresentations for Core Data to be sent to API
//extension Register {
//
